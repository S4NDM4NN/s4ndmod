...
icons/iconw_shotgun_1
{
	nopicmip
	nomipmaps
	{
		map icons/iconw_shotgun_1_select.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen vertex
	}
}
...
bloodMark1
{
	...
	{
		//**********se
		clampmap gfx/damage/blood_stain1.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		//rgbGen identityLighting
		rgbGen		vertex
		alphaGen vertex
...
bloodMark2
{
	...
	{
		//**********se
		clampmap gfx/damage/blood_stain2.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		//rgbGen identityLighting
		rgbGen		vertex
		alphaGen vertex
...
bloodMark3
{
	...
	{
		//**********se
		clampmap gfx/damage/blood_stain3.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		// rgbGen identityLighting
		rgbGen	 vertex
		alphaGen vertex
...
bloodTrail
{
	entityMergable		// allow all the sprites to be merged together
	{
		map gfx/damage/blood_spurt.tga
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen		vertex
		alphaGen	vertex
	}
