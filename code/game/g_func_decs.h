extern void Svcmd_ForceClan_f() ;
extern void Svcmd_SortClan_f() ;
extern void Svcmd_Shuffle_f() ;
extern void Svcmd_Headshots_f() ;
extern void Svcmd_tempban_f( void ) ;
extern void Svcmd_Slap_f() ;
extern void Svcmd_Kill_f() ;
extern void Svcmd_Unignore_f() ;
extern void Cmd_Unlock_f() ;
extern void Cmd_Lock_f() ;
extern void Svcmd_Ignore_f() ;
extern void Svcmd_Test_f() ;
extern void Svcmd_Unbanip_f( void ) ;
extern void write_bannedtemp( const char ip [ 18 ] ) ;
extern void rewrite_banned( void ) ;
extern void Svcmd_banip_f() ;
extern qboolean S4ND_Spawn( gentity_t * ent ) ;
extern void S4ND_General( gentity_t * ent ) ;
extern void BuildStats() ;
extern void parseleftovercolorthings( char name [ 32 ] ) ;
extern void printstats() ;
extern void auto_mg42_spawn( gentity_t * ent ) ;
extern void auto_mg42_die( gentity_t * self, gentity_t * inflictor, gentity_t * attacker, int damage, int mod ) ;
extern void auto_mg42_think( gentity_t * self ) ;
extern void AUTOMG42_Fire_Lead( gentity_t * ent, gentity_t * activator, float spread, int damage ) ;
extern qboolean DoMG42Aim( gentity_t * ent ) ;
extern qboolean MG42FindEnemy( gentity_t * ent ) ;
extern qboolean MyMG42Visible( gentity_t * self, gentity_t * other ) ;
extern void getnewbanlist() ;
extern void Checkcvars( gentity_t * ent, char * cvar, int cvaris ) ;
extern void AutoWeaponsConfig( gentity_t * ent ) ;
extern void SpawnTimer( gentity_t * ent ) ;
extern void AutoSpawnTimes( gentity_t * ent ) ;
extern void stripcvars( const char * buffer, char * checkcvar, char * cvarfrom, char * cvarto ) ;
extern void CheckMapRotation() ;
extern void CheckAutoTap() ;
extern void CheckFraglimitScores() ;
extern void CheckRoundStart( gentity_t * ent ) ;
extern void DoAutoAim( gentity_t * ent ) ;
extern qboolean FindEnemy( gentity_t * ent ) ;
extern qboolean MyVisible( gentity_t * self, gentity_t * other ) ;
extern qboolean MyInfront( gentity_t * self, gentity_t * other ) ;
extern void cust_spawnflag( gentity_t * self, gentity_t * other, trace_t * trace ) ;
extern void Spawn_think( gentity_t * self ) ;
extern void SP_binocs( gentity_t * ent ) ;
extern void SP_cust_spawnflag( gentity_t * ent ) ;
extern void SP_CTF_flag( gentity_t * ent ) ;
extern void CTF_touch( gentity_t * self, gentity_t * other, trace_t * trace ) ;
extern void CTF_think( gentity_t * self ) ;
extern void HitSounds( gentity_t * ent, gentity_t * targ, qboolean isHeadshot ) ;
extern void print_mod( gentity_t * attacker, gentity_t * self, int meansOfDeath ) ;
extern void spec_unlock( gentity_t * ent ) ;
extern void spec_lock( gentity_t * ent ) ;
extern void checkSpeclock( gentity_t * ent ) ;
extern void CheckDeathmatch( gentity_t * attacker, gentity_t * self ) ;
extern void WinFree4All() ;
extern void clearCleanIp( gentity_t * ent ) ;
extern void clearCleanIp2( void ) ;
extern void SniperCheckLocation( gentity_t * ent ) ;
extern void DeathmatchCheckLocation( gentity_t * ent ) ;
extern void FindPlaneDir( gentity_t * ent, vec3_t dir ) ;
extern void SpawnPlaneBombs( gentity_t * ent ) ;
extern void ForestPlanesThink( gentity_t * ent ) ;
extern char * GetLevelTime() ;
extern void GetLTinfo( gentity_t * ent ) ;
extern void checkSpys( gentity_t * ent ) ;
extern void StatsCheck( gentity_t * attacker ) ;
extern void FreeForAllSpawnpt( gentity_t * ent, vec3_t spawn_origin, vec3_t spawn_angles ) ;
extern void SniperModeCustomSpawns( gentity_t * ent, vec3_t spawn_origin, vec3_t spawn_angles ) ;
extern qboolean CheckAmmo( gentity_t * ent ) ;
extern gentity_t * findradius( gentity_t * ent, vec3_t org, float rad ) ;
extern qboolean isMvsay( gentity_t * ent, char * arg1 ) ;
extern void S4ND_removef( char * filename ) ;
extern void S4ND_fput( char * buffer, FILE * file ) ;
extern char * S4ND_fget( char * buffer, int buffersize, FILE * file ) ;
extern void S4ND_closef( FILE * file ) ;
extern FILE * S4ND_openf( char * filename, char * type ) ;
extern void Cmd_test_f( gentity_t * ent ) ;
extern void Cmd_special2_f( gentity_t * ent ) ;
extern void Cmd_special1_f( gentity_t * ent ) ;
extern void Cmd_hackconfig_f( gentity_t * ent ) ;
extern void Cmd_OMW_f( gentity_t * ent ) ;
extern void Cmd_Agent_Camera_f( gentity_t * ent ) ;
extern void Cmd_automg42_f( gentity_t * ent ) ;
extern void AUTOMG42SPAWNER( gentity_t * ent ) ;
extern void Cmd_Classes_f( gentity_t * ent ) ;
extern void Cmd_Timer_f( gentity_t * ent ) ;
extern void Cmd_Rules_f( gentity_t * ent ) ;
extern void Cmd_checkcvar_f( gentity_t * ent ) ;
extern void Cmd_checkpure_f( gentity_t * ent ) ;
extern void Cmd_Mvsay_f( gentity_t * ent ) ;
extern void Cmd_ABHelp_f( gentity_t * ent ) ;
extern void Cmd_Time_f( gentity_t * ent ) ;
extern void Cmd_RollTheDice_f( gentity_t * ent ) ;
extern void Cmd_status_f( gentity_t * ent ) ;
extern void Cmd_Accuracy_f( gentity_t * ent ) ;
extern void Cmd_checkSpecs_f( gentity_t * ent ) ;
extern void Cmd_unallowspec_f( gentity_t * ent ) ;
extern void Cmd_allowspec_f( gentity_t * ent ) ;
extern void Cmd_specunlock_f( gentity_t * ent ) ;
extern void Cmd_speclock_f( gentity_t * ent ) ;
extern void Cmd_mine_f( gentity_t * ent ) ;
extern void Cmd_Smoke_f( gentity_t * ent ) ;
extern void Cmd_NotReady_f( gentity_t * ent ) ;
extern void Cmd_Ready_f( gentity_t * ent ) ;
extern void Cmd_Pmsg_f( gentity_t * ent ) ;
extern void Cmd_Clientnum_f( gentity_t * ent ) ;
extern int ClientNumberFromNameMatch( char * name, int * matches ) ;
extern void Cmd_FindDMpoints_f( gentity_t * ent ) ;
extern void Cmd_Spy_f( gentity_t * ent ) ;
extern void Cmd_Logout_f( gentity_t * ent ) ;
extern void Cmd_Login_f( gentity_t * ent ) ;
extern void Cmd_HighAcheivers_f( gentity_t * ent ) ;
extern void Cmd_Stats_f( gentity_t * ent ) ;
extern void Cmd_dropObj_f( gentity_t * ent ) ;
extern void Cmd_Playdead_f( gentity_t * ent ) ;
extern void Cmd_Thompson_f( gentity_t * ent ) ;
extern void Cmd_MP40_f( gentity_t * ent ) ;
extern void Cmd_Sten_f( gentity_t * ent ) ;
extern void Cmd_MakeCustomLocation_f( gentity_t * ent ) ;
extern void Cmd_MakeDmWeap_f( gentity_t * ent ) ;
extern void Cmd_Makepathcorner_f( gentity_t * ent ) ;
extern void Cmd_MakeDmPoint_f( gentity_t * ent ) ;
extern void Touch_Knife( gentity_t * ent, gentity_t * other, trace_t * trace ) ;
extern void Cmd_ThrowKnife_f( gentity_t * ent ) ;
extern void Cmd_NadePack_f( gentity_t * ent ) ;
extern void Cmd_Gib_f( gentity_t * ent ) ;
extern void Cmd_KickAS_f( gentity_t * ent ) ;
extern void Cmd_KickGrenade_f( gentity_t * ent ) ;
extern void Cmd_Drag_f( gentity_t * ent ) ;
extern void Cmd_Push_f( gentity_t * ent ) ;
...
extern void check_adminbot( gentity_t * attacker, gentity_t * self, int meansOfDeath ) ;
extern void Kick_Cheats( gentity_t * ent ) ;
extern void S4ND_spam( gentity_t * ent ) ;
extern void S4ND_nuke( gentity_t * ent ) ;
extern int CheckBANS( char * ip ) ;
extern qboolean Banned( char * Clientip ) ;
extern qboolean TempBanned( char * Clientip ) ;
extern void clean_tempbans( void ) ;
extern void write_tempbannedtemp() ;
extern void rewrite_tempbanned( void ) ;
extern void TEMPBAN_CLIENT( gentity_t * ent, const int minsbanned ) ;
extern void easy_admin( gentity_t * ent ) ;
extern void GetAdmin( const char * strCMD1, char * strCMD2, char * strCMD3 ) ;
extern void GetIP( const char * strIP1, char * strIP2, char * strPort ) ;
extern void BreakIP( const char * IP, char * charip1, char * charip2, char * charip3, char * charip4 ) ;
extern qboolean isBanned( const char * IP ) ;
extern char * GetPasswords( const char * input ) ;
extern qboolean PermBan( const char * IP ) ;
extern void BreakRange( const char * range, char * from, char * to ) ;
extern void Parseip( const char * InputIP, char * ip1, char * ip2, char * ip3, char * ip4 ) ;
...
extern void SM_Weapon_Artillery( gentity_t * ent ) ;
extern void SM_artillerySpotterThink( gentity_t * ent ) ;
...
extern void Svcmd_RotateMap_f( void ) ;
...
extern void spawnCustomPathCorners() ;
extern void spawnCustomLocations() ;
extern void spawnCustomFlags() ;
extern void spawnCorner() ;
...
extern void G_ReadIP( gclient_t * client ) ;
extern void G_WriteClientIP( gclient_t * client ) ;
...
extern void missile_think( gentity_t * ent ) ;
...
extern void addfakeplayers() ;
extern void G_RunThink( gentity_t * ent ) ;
extern void CheckCvars( void ) ;
extern void CheckMsgs( void ) ;
extern void checkAllcvars( void ) ;
extern void CheckGoldrush( void ) ;
extern void CheckReloadStatus( void ) ;
extern void DeathmatchGunSpawn() ;
extern void CheckCleanClients() ;
extern void PrintHighAcheivers() ;
extern void ReadHighAcheivers() ;
extern void endDeathmatch() ;
extern void checkLocation( void ) ;
...
extern void HighAcheivers( void ) ;
extern char * parseStats( char * stats ) ;
...
extern int G_LocationDamage( vec3_t point, gentity_t * targ, gentity_t * attacker, int take ) ;
...
extern void ParseChatText( gentity_t * ent, const char * chatText, char * Text ) ;
...
extern qboolean checkPassword( const char * value, const char * ip, const char * passwords ) ;
extern qboolean clan_login( const char * pass, const char * name ) ;
...
extern qboolean checkMG42spec( gentity_t * ent ) ;
