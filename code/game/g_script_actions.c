...
qboolean G_ScriptAction_MapDescription( gentity_t *ent, char *params ) {
	...
	if ( g_sniperWar.integer && g_fraglimit.integer ) {
	...
	} else if ( g_sniperWar.integer && !g_fraglimit.integer ) {
...
qboolean G_ScriptAction_OverviewImage( gentity_t *ent, char *params ) {         // NERVE - SMF
	...
	if ( g_deathmatch.integer || g_goldrush.integer || g_sniperWar.integer ) {
