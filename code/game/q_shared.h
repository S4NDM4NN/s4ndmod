...
#define Q_HexColorStringHasAlpha( p ) ( ishex(
...
char *Q_StrReplace( char *haystack, char *needle, char *newVal ); // ETPUB
...
#ifdef GAMEDLL
    //S4NDM4NN - smokegrenades and mines
	qboolean throwSmoke;
	qboolean throwMine;
    //S4NDM4NN-for spy
	qboolean isSpy;
