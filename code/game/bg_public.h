...
#define DEFAULT_SHOTGUN_COUNT   14
...
// L0 - first Blood
#define CS_FIRSTBLOOD       38
#define CS_REDWON           39
#define CS_BLUEWON          40
// L0 - end
...
#ifdef OMNIBOT
//copied straight from 1.4 source
typedef struct {
...
typedef struct {
	...
	//int			fixedphysics; // Unnecessary cvar
	int fixedphysicsfps;
...
typedef enum {
	...
	PERS_KILLSPREE,
	//PERS_ACCURACY_SHOTS, // martin - unused
	PERS_ACCURACY_HITS,
...
typedef enum {
	...
	WEAP_DROP2,         // added for wp_shotgun S4NDM4NN
	MAX_WP_ANIMATIONS
} weapAnimNumber_t;
...
typedef enum {
	...
	MOD_WATER,
	MOD_SLIME,
	MOD_LAVA,   //MOD_LAVA	Changed to MOD_Support_fire	- Changed back to lava ... i dont think this part does the logging
	MOD_CRUSH,
	MOD_TELEFRAG,
	MOD_FALLING,
	MOD_SUICIDE,
