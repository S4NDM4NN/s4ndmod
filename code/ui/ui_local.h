...
downloader_t myDownloader;



void AddReliableCommand_Hook( const char *cmd );
extern void ( WINAPIV *orig_AddReliableCommand )( const char *cmd );
...
extern unsigned ( WINAPIV *orig_Com_BlockChecksumKey )( void *buffer, int length, int key );

void  consolePrint_Hook( char *text );
extern void ( WINAPIV *orig_consolePrint )( char *text );
