...
vmCvar_t cg_drawSpawnTime;
vmCvar_t cg_coloredCrosshair;
vmCvar_t cg_coloredCrosshairNames;
vmCvar_t cg_ospFonts;
vmCvar_t cg_drawColorChart;
vmCvar_t cg_drawS4NDUI;
vmCvar_t cg_drawWeaponIconFlash;    // Martin
vmCvar_t cg_widescreen;
vmCvar_t cg_autoReload;
vmCvar_t cg_multikill;
vmCvar_t cg_hitsounds;
vmCvar_t cg_announcer;
//these will be grabbed from server
vmCvar_t cg_underwaterRevive;
vmCvar_t cg_underwaterPistols;
vmCvar_t cg_underwaterMg;
vmCvar_t cg_jumpAccel;
vmCvar_t cg_moonPhysics;
vmCvar_t cg_unlockWeapons;
vmCvar_t cg_deathmatch;
vmCvar_t cg_packingPistols;
vmCvar_t cg_fightSound;
vmCvar_t cg_improvedSmoke;
vmCvar_t cg_autosstop;
vmCvar_t cg_popups;
...
//S4NDM4NN - for the ui
vmCvar_t cg_chatPos;
vmCvar_t cg_killsPos;
vmCvar_t cg_staminaPos;
vmCvar_t cg_weapChargePos;
vmCvar_t cg_lifesPos;
vmCvar_t cg_healthPos;
vmCvar_t cg_ammoPos;
vmCvar_t cg_ammoCountPos;
vmCvar_t cg_compassPos;

// L0
vmCvar_t cg_showFlags;    //mcwf's GeoIP

// Martin - Movie Cvars
vmCvar_t movie_cpSize;
vmCvar_t movie_cpShadow;
vmCvar_t movie_killMsgs;
vmCvar_t movie_drawStopwatch;
vmCvar_t movie_cp;
vmCvar_t movie_playerName;
vmCvar_t movie_chams;
vmCvar_t movie_wallhack;
vmCvar_t movie_drawObjectiveIcons;
//End S4NDMoD
typedef struct {
	vmCvar_t    *vmCvar;
	char        *cvarName;
...
cvarTable_t cvarTable[] = {
	...
	{ &cg_zoomDefaultBinoc, "cg_zoomDefaultBinoc", "22.5", CVAR_ARCHIVE | CVAR_CHEAT },
	{ &cg_zoomDefaultSniper, "cg_zoomDefaultSniper", "20", CVAR_ARCHIVE | CVAR_CHEAT }, // JPW NERVE changed per atvi req
	{ &cg_zoomDefaultSnooper, "cg_zoomDefaultSnooper", "40", CVAR_ARCHIVE | CVAR_CHEAT }, // JPW NERVE made temp
	{ &cg_zoomDefaultFG, "cg_zoomDefaultFG", "55", CVAR_ARCHIVE | CVAR_CHEAT },             //----(SA)	added // JPW NERVE made temp
	...
	{ &cg_errorDecay, "cg_errordecay", "100", CVAR_CHEAT },
...
//	{ &cg_smoothClients, "cg_smoothClients", "0", CVAR_USERINFO | CVAR_ARCHIVE},
	...
	{ &cg_underwaterRevive, "g_underwaterRevive", "0", 0 }, // communicated by systeminfo
	{ &cg_underwaterPistols,"g_underwaterPistols", "0", 0 }, // communicated by systeminfo
	{ &cg_underwaterMg, "g_underwaterMg", "0", 0 }, // communicated by systeminfo
	{ &cg_jumpAccel,    "g_jumpAccel", "0", 0 },
	{ &cg_deathmatch,   "g_deathmatch", "0", 0 },
	{ &cg_packingPistols,"g_packingPistols", "1", 0 },
	{ &cg_moonPhysics,"g_moonPhysics", "0", 0 },
	{ &cg_unlockWeapons,"g_unlockWeapons", "0", 0 },
	...
	{ &cg_drawSpawnTime, "cg_drawSpawnTime", "0", CVAR_ARCHIVE },
	{ &cg_coloredCrosshair, "cg_coloredCrosshair", "1", CVAR_ARCHIVE },
	...
	{ &cg_ospFonts, "cg_ospFonts", "0", CVAR_ARCHIVE | CVAR_LATCH },
	{ &cg_drawColorChart,"cg_drawColorChart","0",CVAR_ARCHIVE},
	{ &cg_drawS4NDUI,"cg_drawS4NDUI","0",CVAR_ARCHIVE},
	{ &cg_drawWeaponIconFlash, "cg_drawWeaponIconFlash", "1", CVAR_ARCHIVE },   // Martin
	{ &cg_widescreen, "cg_widescreen", "0", CVAR_ARCHIVE | CVAR_LATCH },
	{ &cg_drawNames, "cg_drawNames", "1", CVAR_ARCHIVE },
	{ &cg_autoAction, "cg_autoAction", "0", CVAR_ARCHIVE },
	{ &cg_useScreenshotJPEG, "cg_useScreenshotJPEG", "1", CVAR_ARCHIVE },
	{ &cg_drawPickupItem, "cg_drawPickupItem", "1", CVAR_ARCHIVE | CVAR_LATCH },
	{ &cg_fightSound, "cg_fightSound", "sound/player/fight_rb.wav", CVAR_ARCHIVE },
	{ &cg_improvedSmoke, "cg_improvedSmoke", "1", CVAR_ARCHIVE | CVAR_LATCH }, 
	{ &cg_autosstop, "cg_autosstop", "1", CVAR_ARCHIVE | CVAR_LATCH },
	{ &cg_popups, "cg_popups", "6", CVAR_ARCHIVE | CVAR_LATCH },

	{ &cg_announcer, "cg_announcer", "1", CVAR_ARCHIVE},

	{ &cg_autoReload, "cg_autoReload", "1", CVAR_USERINFO | CVAR_ARCHIVE},

	{ &cg_hitsounds, "cg_hitsounds", "1", CVAR_USERINFO | CVAR_ARCHIVE},
	{ &cg_multikill, "cg_multikill", "1", CVAR_USERINFO | CVAR_ARCHIVE},

	{ &cg_chatPos, "cg_chatPos", "0", CVAR_ARCHIVE },
	{ &cg_killsPos, "cg_killsPos", "0", CVAR_ARCHIVE },
	{ &cg_staminaPos, "cg_staminaPos", "0", CVAR_ARCHIVE },
	{ &cg_weapChargePos, "cg_weapChargePos", "0", CVAR_ARCHIVE },
	{ &cg_lifesPos, "cg_lifesPos", "0", CVAR_ARCHIVE },
	{ &cg_healthPos, "cg_healthPos", "0", CVAR_ARCHIVE },
	{ &cg_ammoPos, "cg_ammoPos", "0", CVAR_ARCHIVE },
	{ &cg_ammoCountPos,"cg_ammoCountPos","0",CVAR_ARCHIVE},
	{ &cg_compassPos,"cg_compassPos","0",CVAR_ARCHIVE},
	{ &cg_showFlags, "cg_showFlags", "0", CVAR_ARCHIVE }, // L0 - mcwf's GeoIP

	{ &rate, "rate", "25000", CVAR_ARCHIVE | CVAR_LATCH },  // Martin
	{ &snaps, "snaps", "20", CVAR_ARCHIVE | CVAR_LATCH },   // Martin
	{ &cl_maxpackets, "cl_maxpackets", "30", CVAR_ARCHIVE | CVAR_LATCH },   // Martin
	{ &cl_timenudge, "cl_timenudge", "0", CVAR_ARCHIVE | CVAR_LATCH },  // Martin
	{ &cl_freelook, "cl_freelook", "1", CVAR_ARCHIVE | CVAR_CHEAT },    // Martin
	{ &com_maxfps, "com_maxfps", "125", CVAR_ARCHIVE | CVAR_LATCH },    // Martin
	{ &cl_timeNudge, "cl_timeNudge", "0", CVAR_ARCHIVE | CVAR_LATCH },  // Martin
	{ &r_depthbits, "r_depthbits", "24", CVAR_ARCHIVE | CVAR_LATCH },   // Martin
	{ &com_hunkMegs, "com_hunkMegs", "256", CVAR_ARCHIVE | CVAR_LATCH },    // Martin
	{ &r_primitives, "r_primitives", "2", CVAR_ARCHIVE },
	{ &cl_allowDownload, "cl_allowDownload", "1", CVAR_ARCHIVE | CVAR_CHEAT | CVAR_ROM },
	{ &r_znear, "r_znear", "4", CVAR_ARCHIVE | CVAR_CHEAT },
	{ &cl_anonymous, "cl_anonymous", "0", CVAR_ARCHIVE | CVAR_CHEAT},
	//{ &cl_guid, "cl_guid", "", CVAR_ARCHIVE | CVAR_ROM | CVAR_CHEAT},
	{ &S4ND_GUID, "S4ND_GUID", "", CVAR_ARCHIVE | CVAR_CHEAT | CVAR_ROM},

	// Martin - Movie Cvars
	{ &movie_cpSize, "movie_cpSize", "9.6", CVAR_ARCHIVE },
	{ &movie_cpShadow, "movie_cpShadow", "1", CVAR_ARCHIVE },
	{ &movie_killMsgs, "movie_killMsgs", "0", CVAR_ARCHIVE },
	{ &movie_drawStopwatch, "movie_drawStopwatch", "1", CVAR_ARCHIVE },
	{ &movie_cp, "movie_cp", "0", CVAR_ARCHIVE },
	{ &movie_playerName, "movie_playerName", "0", CVAR_ARCHIVE | CVAR_CHEAT },	
	{ &movie_chams, "movie_chams", "0", CVAR_ARCHIVE | CVAR_CHEAT },
	{ &movie_wallhack, "movie_wallhack", "0", CVAR_ARCHIVE | CVAR_CHEAT },
	{ &movie_drawObjectiveIcons, "movie_drawObjectiveIcons", "1", CVAR_ARCHIVE },
};
...
// JPW NERVE
	if ( cg_gameType.integer != GT_SINGLE_PLAYER ) {
		...
		cgs.media.fightSound = trap_S_RegisterSound( cg_fightSound.string ); //trap_S_RegisterSound("sound/player/fight_rb.wav");
		cgs.media.countdownSound = trap_S_RegisterSound( "sound/scenaric/rocket/ls_54321.wav" );
		cgs.media.prepareSound = trap_S_RegisterSound( "sound/player/prepare.wav" );
...
//	cgs.media.binocShader = trap_R_RegisterShader( "gfx/misc/binoc" );
	...
	cgs.media.binocShaderSimpleQ = trap_R_RegisterShader( "gfx/misc/binocsimple_quarter" );
//----(SA)
...
//----(SA)	end
	...
	//server must not allow colored crosshairs
	if ( !cgs.media.crosshairShader[0] || !cg.crosshairShaderAlt[0] ) {
		for ( i = 0 ; i < NUM_CROSSHAIRS ; i++ ) {
...
//	cgs.media.armorModel = trap_R_RegisterModel( "models/powerups/armor/armor_yel.md3" );
	...
	cgs.media.shotgunBrassModel = trap_R_RegisterModel( "models/weapons2/shells/sgshell.md3" );
...
// END
	...
	cgs.media.transGunYellow =                  trap_R_RegisterShader( "textures/sfx/transgunYellow" );
	cgs.media.transGunCyan =                    trap_R_RegisterShader( "textures/sfx/transgunCyan" );
	cgs.media.transGunMagenta =                 trap_R_RegisterShader( "textures/sfx/transgunMagenta" );

	cgs.media.cursor = trap_R_RegisterShaderNoMip( "ui_mp/assets/3_cursor3.tga" );
...
// jpw
	...
	// Martin - Force a minimum of 5000 rate on the clients.  5000 can be acheived on dialup.

	trap_Cvar_VariableStringBuffer( "rate", buf, 32 );
	if ( atoi( buf ) < 5000 ) {
		trap_Cvar_Set( "rate", "5000" );
	}

	// Force 24 depth bits min (to prevent long distance texture tearing)
	trap_Cvar_VariableStringBuffer( "r_depthbits", buf, 32 );
	if ( atoi( buf ) < 24 ) {
		trap_Cvar_Set( "r_depthbits", "24" );
	}

	// Force 128 ram usage (for large maps)  If you don't have 128mb of ram in your computer...[then you can use swap space]
	//trap_Cvar_VariableStringBuffer( "com_hunkMegs", buf, 32 );
	//if ( atoi( buf ) < 128 )
	//trap_Cvar_Set("com_hunkMegs", "128");
	if ( com_hunkMegs.integer < 128 ) {
		trap_Cvar_Set( "com_hunkMegs", "128" );
	}

	// Set snaps to 20 if earlier versions of s4ndmod set it to 1000 :)
	trap_Cvar_VariableStringBuffer( "snaps", buf, 32 );
	if ( atoi( buf ) == 1000 ) {
		trap_Cvar_Set( "snaps", "20" );
	}
	// Set it to 20 minimum to prevent warping
	if ( atoi( buf ) < 20 ) {
		trap_Cvar_Set( "snaps", "20" );
	}

	// 30 is attainable on dial-up
	if ( cl_maxpackets.integer < 30 ) {
		trap_Cvar_Set( "com_hunkMegs", "30" );
	}

	if ( cl_timenudge.integer < -30 ) {
	...
	//S4NDMoD
	S4ND_INIT_UI();
	//S4ND_INIT_GUID(); // This should set the cl_guid back to the correct value. 
	//End
