...
//			break;
		...
		case MOD_SHOTGUN:
			...
			break;
		case MOD_FALLING:
			message = "was pushed to his death by";
			message2 = "";
			break;
		default:
			message = "was killed by";
...
// JPW NERVE if attacker != target but on same team
		if ( ci->team == ca->team && cg_deathmatch.integer != 2 ) {
...
// jpw
	...
	case EV_SHOTGUN_PUMP:
		...
		trap_S_StartSound( NULL, es->number, CHAN_WEAPON, cg_weapons[es->weapon].shotgunPump ); // hijacking this sound for a shotgun
		break;
