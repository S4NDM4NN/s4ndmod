...
// S4NDMoD
// 1 is used for turning the functionality on/off
#define KILLMSG_SHOWDISCONNECTS		2
#define KILLMSG_SHOWOBJ				4
#define KILLMSG_SHOWKICKS			8
#define KILLMSG_SHOWPLAYERKILLS		16
#define KILLMSG_SHOWALLKILLS		32
#define KILLMSG_REVERSENOTIFYORDER	64
...
//----(SA) end
	...
	qhandle_t shotgunSkins[TEAM_NUM_TEAMS][2];       //S4NDM4NN - added to register shotgun skins
} weaponInfo_t;
...
//S4NDM4NN ripped from noquarter
...
typedef struct {
	...
	qboolean followingrocket;
	qboolean followRocket;

	vec3_t camOrigin;

	qboolean keyup_isdown;
	qboolean keydown_isdown;
	qboolean keyspeed_isdown;
	qboolean keyforward_isdown;
	qboolean keybackward_isdown;
	qboolean keyleft_isdown;
	qboolean keyright_isdown;
	// -viewpoint
...
// JPW FIXME NOTE: max_weap_banks > max_weap_banks_mp so this should be OK, but if that changes, change this too
	...
	//S4NDM4NN - for drawing names on screen
...
//	sfxHandle_t suddenDeathSound;
	...
	sfxHandle_t countdownSound;
	sfxHandle_t prepareSound;
// jpw
...
//----(SA)
	...
	// L0
	qhandle_t countryFlags; //mcwf's GeoIP
	...
	qhandle_t transGunYellow;
	qhandle_t transGunCyan;
	qhandle_t transGunMagenta;
...
typedef struct {
	...
	char notifyMsgs[30][30 * 3 + 1]; // Martin for modified movie kill list.
	int notifyMsgTimes[30]; // Martin
	int notifyPos;
	int notifyLastPos;
...
extern vmCvar_t cg_drawSpawnTime;
extern vmCvar_t cg_coloredCrosshair;
extern vmCvar_t cg_coloredCrosshairNames;
extern vmCvar_t cg_ospFonts;
extern vmCvar_t cg_drawColorChart;
extern vmCvar_t cg_drawS4NDUI;
...
extern vmCvar_t	cg_improvedSmoke;
extern vmCvar_t	cg_autosstop;
extern vmCvar_t	cg_popups;
extern vmCvar_t cg_announcer;

extern vmCvar_t cg_chatPos;
extern vmCvar_t cg_killsPos;
extern vmCvar_t cg_staminaPos;
extern vmCvar_t cg_weapChargePos;
extern vmCvar_t cg_lifesPos;
extern vmCvar_t cg_healthPos;
extern vmCvar_t cg_ammoPos;
extern vmCvar_t cg_ammoCountPos;
extern vmCvar_t cg_compassPos;

extern vmCvar_t cg_showFlags; //L0 - mcwf's GeoIP
...
// Martin - Movie Cvars
extern vmCvar_t movie_cpSize;
extern vmCvar_t movie_cpShadow;
extern vmCvar_t movie_killMsgs;
extern vmCvar_t movie_drawStopwatch;
extern vmCvar_t movie_cp;
extern vmCvar_t	movie_playerName;
extern vmCvar_t	movie_chams;
extern vmCvar_t movie_wallhack;
extern vmCvar_t movie_drawObjectiveIcons;
// -NERVE - SMF
...
//S4NDM4NN added my so font wont change
...
void S4ND_UI_doUI();
void S4ND_INIT_UI();
extern int compassPos[4];
extern int healthPos[4];
extern int lifesPos[4];
extern int ammoPos[4];
extern int ammocountPos[4];
extern int chartimePos[4];
extern int staminaPos[4];
extern int chargetimePos[4];
extern int chatPos[4];
extern int killPos[4];
//end S4NDMoD
